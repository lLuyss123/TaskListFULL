    ...
    <header class="border-b border-blue-100 bg-white/90 backdrop-blur">
      <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
        ...
        <nav class="hidden gap-3 md:flex">
          ...
          <a class="rounded-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white">Perfil</a>
        </nav>
      </div>
    </header>
        ...
        <section class="rounded-4xl border border-blue-100 bg-white p-8 shadow-xl shadow-blue-50">
          <form class="grid gap-5">
            ...
            <div class="flex flex-col gap-3 pt-2 sm:flex-row">
              <a class="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-500" >Guardar cambios</a>
              <a class="inline-flex items-center justify-center rounded-2xl border border-blue-200 bg-white px-5 py-3 text-sm font-bold text-blue-700 hover:bg-blue-50" >Eliminar mi cuenta</a>
            </div>
          </form>
        </section>
      </section>
